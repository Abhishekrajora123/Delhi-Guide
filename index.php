    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item fa fa-lock" href="#"> login</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="test.php?id=5" value = "5">5 Star</a>
          <a class="dropdown-item" href="test.php?id=4" value = "4">4 Star</a>
          <a class="dropdown-item" href="test.php?id=3" value = "3">3 Star</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="#">Dhabas</a>
          <a class="dropdown-item" href="#">Street vendors</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="#">Temples</a>
          <a class="dropdown-item" href="#">Parks</a>
          <a class="dropdown-item" href="#">Zoo</a>
          <a class="dropdown-item" href="#">Connaught Palace</a>
  ...
  <div class="col-sm-2">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Jantar Mantar is located in the modern city of New Delhi. “Jantar Mantar” literally means “instruments for measuring the harmony of the heavens”. It consists of 13 architectural astronomy instruments.</p>
      </div>
    </div>
  </div>
  <div class="col-sm-2">
